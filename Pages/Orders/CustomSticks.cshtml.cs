...
namespace boutaburger.Pages.Orders
{
    ...
    public class CustomSticksModel : PageModel
    {
        ...
        public CustomSticksModel(CartItemDbContext dbContext, MenuItemDbContext menuItemDbContext)
        {
        ...
        [BindProperty]
        public CartItem sticks { get; set; }
        ...
        public IActionResult OnPost()
        {
            var menuItemData = menuItemDbContext.MenuItems
                .FirstOrDefault(item => item.Name == "Mozzarella Sticks");
