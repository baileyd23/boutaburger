...
namespace boutaburger.Pages.Orders
{
    ...
    public class CustomCookieModel : PageModel
    {
        ...
        public CustomCookieModel(CartItemDbContext dbContext, MenuItemDbContext menuItemDbContext)
        {
        ...
        [BindProperty]
        public CartItem cookie { get; set; }
        ...
        public IActionResult OnPost()
        {
            var menuItemData = menuItemDbContext.MenuItems
                .FirstOrDefault(item => item.Name == "Cookie");
