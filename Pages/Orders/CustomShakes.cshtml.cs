...
namespace boutaburger.Pages.Orders
{
    ...
    public class CustomShakesModel : PageModel
    {
        ...
        public CustomShakesModel(CartItemDbContext dbContext, MenuItemDbContext menuItemDbContext)
        {
        ...
        [BindProperty]
        public CartItem shakes { get; set; }
        ...
        public IActionResult OnPost()
        {
            var menuItemData = menuItemDbContext.MenuItems
                .FirstOrDefault(item => item.Name == "Milkshake");
