...
namespace boutaburger.Pages.Orders
{
    ...
    public class CustomRingsModel : PageModel
    {
        ...
        public CustomRingsModel(CartItemDbContext dbContext, MenuItemDbContext menuItemDbContext)
        {
        ...
        public IActionResult OnPost()
        {
            var menuItemData = menuItemDbContext.MenuItems
                .FirstOrDefault(item => item.Name == "Onion Rings");
