...
namespace boutaburger.Pages.Orders
{
    ...
    public class CustomSoulModel : PageModel
    {
        ...
        public CustomSoulModel(CartItemDbContext dbContext, MenuItemDbContext menuItemDbContext)
        {
        ...
        public IActionResult OnPost()
        {
            var menuItemData = menuItemDbContext.MenuItems
                .FirstOrDefault(item => item.Name == "Sell your Soul Burger");
