...
namespace boutaburger.Pages.Orders
{
    ...
    public class CustomMeltingModel : PageModel
    {
        ...
        public CustomMeltingModel(CartItemDbContext dbContext, MenuItemDbContext menuItemDbContext)
        {
        ...
        [BindProperty]
        public CartItem Melting { get; set; }
        ...
        public IActionResult OnPost()
        {
            var menuItemData = menuItemDbContext.MenuItems
                .FirstOrDefault(item => item.Name == "I'm Melting Burger");
