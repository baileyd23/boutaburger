...
namespace boutaburger.Pages.Orders
{
    ...
    public class CustomBurgerModel : PageModel
    {
        ...
        public CustomBurgerModel(CartItemDbContext dbContext, MenuItemDbContext menuItemDbContext)
        {
        ...
        public IActionResult OnPost()
        {
            var menuItemData = menuItemDbContext.MenuItems
                .FirstOrDefault(item => item.Name == "As Gooda as it Gets");
