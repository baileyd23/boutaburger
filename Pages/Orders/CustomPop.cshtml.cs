...
namespace boutaburger.Pages.Orders
{
    ...
    public class CustomPopModel : PageModel
    {
        ...
        public CustomPopModel(CartItemDbContext dbContext, MenuItemDbContext menuItemDbContext)
        {
        ...
        public IActionResult OnPost()
        {
            var menuItemData = menuItemDbContext.MenuItems
                .FirstOrDefault(item => item.Name == "Fountain Drink");
