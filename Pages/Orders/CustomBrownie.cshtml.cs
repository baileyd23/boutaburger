...
namespace boutaburger.Pages.Orders
{
    ...
    public class CustomBrownieModel : PageModel
    {
        ...
        public CustomBrownieModel(CartItemDbContext dbContext, MenuItemDbContext menuItemDbContext)
        {
        ...
        [BindProperty]
        public CartItem brownie { get; set; }
        ...
        public IActionResult OnPost()
        {
            var menuItemData = menuItemDbContext.MenuItems
                .FirstOrDefault(item => item.Name == "Brownie");
